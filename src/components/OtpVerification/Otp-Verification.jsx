    ...
    <div className="form-container flex flex-col items-center w-11/12 md:w-8/12 lg:w-7/12 xl:w-5/12 bg-white py-6 pb-12 px-8 md:px-20 rounded-xl h-[90vh] overflow-y-auto">
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center col-span-2">
          <span className="text-black text-[10px] sm:text-[14px] w-full text-center">
            OTP expires in: {timer} seconds
          </span>
        </div>
        <div className="flex flex-col items-center col-span-2 ">
          <p className="text-black text-[10px] sm:text-[14px] w-full text-center my-2">
            Haven't received?&nbsp;&nbsp;&nbsp;{" "}
            <span className="cursor-pointer text-blue-600" onClick={resetTimer}>
              Resend
            </span>
          </p>
        </div>
