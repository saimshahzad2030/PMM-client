              ...
              <div className="flex flex-col items-center col-span-2">
                <TextField
                  ...
                  error={
                    submitButtonClicked &&
                    touched.query &&
                    Boolean(errors.query)
                  }
                  helperText={
                    submitButtonClicked && touched.query && errors.query
                  }
                />
              </div>
              <div className="flex flex-col items-start col-span-2">
                <button
                  className="rounded-md button bg-[#E3BB59] text-white p-2 px-4 w-auto"
                  type="submit"
