  ...
  return (
    ...
    <div className="flex flex-col items-start md:flex-row md:items-end md:justify-between  w-full mb-8">
                ...
                <div className="flex flex-row items-center mt-4 md:mt-0">
                    ...
                    <button className='button text-[10px] sm:text-[16px] bg-white text-[#E3BB59] py-[3px] lg:py-[6px] px-2 border border-[#E3BB59]  rounded-md hover:bg-[#E3BB59] hover:text-white hover:border-white transition-all duration-300'>Account Settings</button>
                </div>
              </div>
    </div>
