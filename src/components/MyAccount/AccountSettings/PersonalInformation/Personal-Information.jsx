...
import { TextField,useMediaQuery,Select, MenuItem, FormControl, InputLabel } from "@mui/material";
...
const validationSchema = Yup.object({
  ...
  phone: Yup.number().min(11, "must be a valid number").required("Phone is Required"),
...
const PersonalInformation = ({ user }) => {
    ...
    <div className="form-container flex flex-col items-center w-full bg-white py-2 sm:py-6 pb-12 ">
      <Formik
        ...
        onSubmit={async(values) => {
          ...
          const user  = await updateInfo(formattedValues.email,formattedValues.fullname,formattedValues.dob,formattedValues.phone,formattedValues.gender)
         }}
          ...
          <Form className="w-full">
            ...
            <div className="flex flex-col items-center col-span-1">
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                <p className="text-red-700 text-[11px] w-full text-start">{submitButtonClicked && touched.dob && errors.dob}</p>
  ...
  <FormControl
    fullWidth
    error={submitButtonClicked && touched.gender && Boolean(errors.gender)}
    size={isSmallScreen ? "small" : "medium"}
  >
    ...
    {submitButtonClicked && touched.gender && Boolean(errors.gender) && (
